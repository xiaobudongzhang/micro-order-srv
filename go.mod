...
require (
	...
	github.com/micro-in-cn/tutorials/microservice-in-micro v0.0.0-20200430044506-2451e30bf530 // indirect
	github.com/micro/go-micro/v2 v2.6.0
	github.com/xiaobudongzhang/micro-basic v1.1.5
	github.com/xiaobudongzhang/micro-inventory-srv v1.0.0
	github.com/xiaobudongzhang/micro-payment-srv v0.0.0-00010101000000-000000000000 // indirect
